...
export default function DocumentUploader({ onUploadSuccess }) {
    ...
    return (
        <div className="space-y-5">
            <div
                className={`relative rounded-2xl border-2 border-dashed p-10 text-center transition-all duration-200 ${dragActive
            ...
            >
                ...
                <div className="flex flex-col items-center gap-4">
                    <div className={`flex h-16 w-16 items-center justify-center rounded-2xl transition-colors ${dragActive ? 'bg-blue-100 text-blue-600' : 'bg-slate-200 text-slate-500'}`}>
            ...
            {uploadProgress && (
                <div className="flex items-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-4 py-3">
                    ...
                    <span className="text-base text-blue-700">{uploadProgress}</span>
                </div>
            )}

            {result && (
                <div className={`rounded-xl border px-4 py-3 text-base ${result.type === 'success'
