            ...
            <section className="float-in stagger-2 mx-auto w-full max-w-310 px-4">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {visiblePosts.map((post, index) => (
                        <article onClick={() => handlePostClick(post)} className="cursor-pointer group flex flex-col justify-between overflow-hidden rounded-2xl border border-[#e8d5bf] bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(242,104,42,0.15)] hover:border-[#f2682a]/40" key={post.id || post.title}>
                            {post.imageUrl && (
                                <div className="block h-40 overflow-hidden bg-slate-100 text-left">
                            ...
                            <div className="flex flex-1 flex-col justify-between p-6">
                                ...
                                <div className="mt-8 flex items-center justify-between border-t border-slate-100 pt-5">
                                    ...
                                    <div className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest text-[#f2682a] group-hover:text-[#d3561f] transition-colors">
