...
# Normalize message spacing and formatting.
def _normalize_message(message: str) -> str:
    return " ".join(message.strip().lower().split())


# Quick answer for simple greetings without calling LLM.
...
class ChatUseCase:
    ...
    # Get the recent chat history turns as context for the LLM.
    ...
    # Handle main business logic for the current module.
    ...
    # Coordinate quick answer or RAG stream for a question.
