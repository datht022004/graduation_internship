...
# Initialize embedding model according to configured provider.
def get_embeddings():
...
# Initialize shared vector store for RAG.
...
# Get initialized vector store to query documents.
...
# Delete vector chunks by document ID.
